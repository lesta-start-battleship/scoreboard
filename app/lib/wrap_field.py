...
import logging
from typing import Self, no_type_check, Any
from fastapi import Path, Query
from pydantic import Field
from pydantic.fields import FieldInfo

from app.lib.filter import FilterType, inclusion_filter
...
def wrap_field(field_info: Any) -> Any:
    ...
    Examples:
        ...
        >>> from workspace.lib.schemas.fields import wrap_field
        >>>
    ...
    class WrappedField(field_info.__class__):  # type: ignore
        ...
        def to_class(self, _class: Any, **new_kwargs: Any) -> Any:
            ...
            Args:
                ...
                **new_kwargs: Keyword arguments to pass to the class constructor.
        ...
        def to_query(self) -> Any:
            ...
            if hasattr(self, "_query_cache"):
                return self._query_cache # type: ignore[return-value]
            kwargs = self._get_kwargs()
            kwargs.pop("default")
            query = Query(**kwargs)
