...
def sync_detailed(
    *,
    ...
    Args:
        ...
        ids (Union[None, Unset, list[UUID]]): Chat IDs to filter users by
        name_ilike (Union[None, Unset, str]): Filter users by name using case-insensitive partial
            match
        order_by_gold (Union[None, OrderByType, Unset]): Order users by gold amount
        order_by_experience (Union[None, OrderByType, Unset]): Order users by experience amount
        order_by_rating (Union[None, OrderByType, Unset]): Order users by rating value
        is_deleted (Union[None, Unset, bool]): Filter users by deletion status
